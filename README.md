...
> state is derived from facts — one private record, one lifecycle writer;
> 51 invariant + 28 APM tests;
...
test/intent.test.mjs               APM lifecycle + negative suite (28 tests)
